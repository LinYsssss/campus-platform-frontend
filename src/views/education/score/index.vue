    ...
    <el-card shadow="never">
      ...
      <el-table :data="tableData" v-loading="loading" stripe>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            <el-button v-if="row.status === 0" link type="primary" @click="handleEdit(row)">录入</el-button>
            <el-button v-if="row.status === 0" link type="primary" @click="handleSubmitAudit(row)">提交审核</el-button>
...
import { getScorePage, addScore, submitScoreAudit, auditScore, submitScoreAppeal } from '@/api/score'
